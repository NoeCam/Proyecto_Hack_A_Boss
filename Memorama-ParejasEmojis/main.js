...
function flipCard(e){
    ...
    if (movesCounter == 0){
        ...
        // TODO => lógica para empezar a sumar segundos
        if (timerOnOff === false){
...
function setTimePointsEmojis(){
    ...
    // if (minCounter > 0){
    //     return puntuationTimeEmojis[100];
    // } else if (secondsCounter <= 20){
    //     return puntuationTimeEmojis[20];
    // } else if (secondsCounter <= 40){
    //     return puntuationTimeEmojis[40];
    // } else if (secondsCounter <= 60){
    //     return puntuationTimeEmojis[60];
    // } else if (secondsCounter <= 80){
    //     return puntuationTimeEmojis[80]
    // };
    if (minCounter > 0){
        return 100;
    } else if (secondsCounter <= 20){
...
function recolectData(){
    ...
    winTotalTime.innerHTML = `Tiempo total: 0${minCounter}:${Math.floor(secondsCounter)}`;
    totalTimeEmoji.innerHTML = `${puntuationTimeEmojis[setTimePointsEmojis()]}`;
    winTotalPoints.innerHTML = `Puntos obtenidos: ${Number(pointsCounter) + Number(givePoints()) + Number(puntuationTimePoints[setTimePointsEmojis()])}`;
};
